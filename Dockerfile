...
RUN apt-get install -y -q nginx ruby2.1 ruby2.1-dev make cmake git-core openssh-server redis-server checkinstall libgit2-dev libxml2-dev libxslt-dev libicu-dev logrotate libpq-dev sudo git openssl nodejs
